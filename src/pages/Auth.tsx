      ...
      <div className="glass-card p-8 w-full max-w-md space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          <Button type="button" variant="outline" disabled={submitting} onClick={async () => {
            ...
            if (r.error) { setSubmitting(false); toast({ title: "Google sign-in failed", description: r.error.message, variant: "destructive" }); }
          }}>
          ...
          <Button type="button" variant="outline" disabled={submitting} onClick={async () => {
            ...
            if (r.error) { setSubmitting(false); toast({ title: "Apple sign-in failed", description: r.error.message, variant: "destructive" }); }
          }}>
